      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
        {models.map((model) => (
          <button
            ...
            className="group relative rounded-2xl overflow-hidden cursor-pointer aspect-[2/3] shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 hover:scale-[1.02]"
          >
            <img
              src={model.image}
